...
Generated from: ('custom_test1.xml',)
...
enums["TEST_DATA"] = {}
TEST_DATA_1 = 1
enums["TEST_DATA"][1] = EnumEntry("TEST_DATA_1", """testing 1""")
TEST_DATA_2 = 2
enums["TEST_DATA"][2] = EnumEntry("TEST_DATA_2", """tesing 2""")
TEST_DATA_ENUM_END = 3
enums["TEST_DATA"][3] = EnumEntry("TEST_DATA_ENUM_END", """""")

# message IDs
MAVLINK_MSG_ID_BAD_DATA = -1
MAVLINK_MSG_ID_UNKNOWN = -2
MAVLINK_MSG_ID_TEST_TRANSMISSION = 1


class MAVLink_test_transmission_message(MAVLink_message):
    """
    Test whether code is capable of sending and receiving data /
    messages
    """

    id = MAVLINK_MSG_ID_TEST_TRANSMISSION
    msgname = "TEST_TRANSMISSION"
    fieldnames = ["message_sent_1", "message_sent_2"]
    ordered_fieldnames = ["message_sent_1", "message_sent_2"]
    fieldtypes = ["uint8_t", "uint8_t"]
    fielddisplays_by_name: Dict[str, str] = {}
    fieldenums_by_name: Dict[str, str] = {"message_sent_1": "TEST_DATA", "message_sent_2": "TEST_DATA"}
    fieldunits_by_name: Dict[str, str] = {}
    ...
    def __init__(self, message_sent_1: int, message_sent_2: int):
        MAVLink_message.__init__(self, MAVLink_test_transmission_message.id, MAVLink_test_transmission_message.msgname)
        self._fieldnames = MAVLink_test_transmission_message.fieldnames
        self._instance_field = MAVLink_test_transmission_message.instance_field
        self._instance_offset = MAVLink_test_transmission_message.instance_offset
        self.message_sent_1 = message_sent_1
        self.message_sent_2 = message_sent_2

    def pack(self, mav: "MAVLink", force_mavlink1: bool = False) -> bytes:
        return self._pack(mav, self.crc_extra, self.unpacker.pack(self.message_sent_1, self.message_sent_2), force_mavlink1=force_mavlink1)


# Define name on the class for backwards compatibility (it is now msgname).
# Done with setattr to hide the class variable from mypy.
setattr(MAVLink_test_transmission_message, "name", mavlink_msg_deprecated_name_property())


mavlink_map: Dict[int, Type[MAVLink_message]] = {
    MAVLINK_MSG_ID_TEST_TRANSMISSION: MAVLink_test_transmission_message,
}
...
class MAVLink(object):
    ...
    def test_transmission_encode(self, message_sent_1: int, message_sent_2: int) -> MAVLink_test_transmission_message:
        """
        Test whether code is capable of sending and receiving data / messages

        message_sent_1            : 1st message transmitted (type:uint8_t, values:TEST_DATA)
        message_sent_2            : 2nd message transmitted (type:uint8_t, values:TEST_DATA)

        """
        return MAVLink_test_transmission_message(message_sent_1, message_sent_2)

    def test_transmission_send(self, message_sent_1: int, message_sent_2: int, force_mavlink1: bool = False) -> None:
        """
        Test whether code is capable of sending and receiving data / messages
        ...
        """
        self.send(self.test_transmission_encode(message_sent_1, message_sent_2), force_mavlink1=force_mavlink1)
